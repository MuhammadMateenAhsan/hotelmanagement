      ...
      </div>
{
 api.map((api) => (
  ...
  <div className="col-lg-3 carouselbtn">
    ...
    <table>
      <tr>
        <td><Link to={`/updaterooms/${api._id}`}><button className="btn updatebtn" style={{width:"95%"}}>
       Update </button></Link></td>
       <td><button style={{width:"95%", backgroundColor:"rgb(170, 13, 13)"}} className="btn btn-danger" onClick={()=>deletedatafromapi(api._id)}>Delete</button></td>
      </tr>
    </table>
